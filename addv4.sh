...
add-ip() {
    ...
    ran=$(date +%s)
    versi="3"
    git clone https://github.com/kenDevXD/izinn.git /root/ipvps/ &> /dev/null
    clear
    ...
    git remote add origin https://github.com/kenDevXD/izinn
    git push -f https://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@github.com/kenDevXD/izinn.git &> /dev/null
    rm -rf /root/ipvps
    clear
    ...
    echo -e "===================================="
    echo -e " apt install -y wget screen && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/kenDevXD/vps/main/main.sh && chmod +x main.sh && screen -S install ./main.sh "
    echo -e "====================================="
    echo -e " Baru Yg Ini : "
    echo -e "====================================="
    echo -e " wget https://raw.githubusercontent.com/kenDevXD/vps/main/update.sh && chmod +x update.sh && ./update.sh "
    echo -e "===================================="
    echo -e " TUNGGU 5 MENIT BARU INSTALL"
    echo -e "===================================="
    echo -e " INSTALL SECRIPT JENGKOLONLINE"
    echo -e "====================================="
    echo -e " wget --no-check-certificate https://raw.githubusercontent.com/kenDevXD/scvip/main/ub20.sh && chmod +x ub20.sh && ./ub20.sh "
    echo -e "====================================="
    echo ""
...
renew-ip() {
    ...
    cd /root/ipvps
    git config --global user.email "zakygras@gmail.com" &> /dev/null
    git config --global user.name "kenDevXD" &> /dev/null
    rm -rf .git &> /dev/null
    git init &> /dev/null
    git add . &> /dev/null
